<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="BarterSystem.WebForms.Account.Register" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                ...
                <a href="/Account/Login.aspx" class="btn btn-default">Sing in</a>
            </div>
        </div>
    </div>
</asp:Content>
